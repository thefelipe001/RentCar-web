...
<body>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <a class="text-body pr-3" href=""><i class="fa fa-phone-alt mr-2"></i>+1829 901 2050</a>
                    <span class="text-body">|</span>
                    <a class="text-body px-3" href=""><i class="fa fa-envelope mr-2"></i>f.mejia25@unapec.edu.do</a>
                </div>
            </div>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="car.html" class="dropdown-item">Listado de Autos</a>
                                <a href="detail.html" class="dropdown-item">Detalles del Auto</a>
                                <a href="booking.html" class="dropdown-item">Reserva de Auto</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
    ...
    <div class="container-fluid bg-secondary py-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            ...
            <p class="mb-4">Disfruta de momentos únicos. Temporadas de ofertas exclusivas. Encuentra todo lo que necesitas con comodidad y calidad.</p>
    ...
    <p class="mb-2 text-center text-body">&copy; <a href="#">Nombre de tu Sitio</a>. Todos los Derechos Reservados.</p>
    </div>
    <!-- Footer End -->
